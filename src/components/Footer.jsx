    ...
    return <footer>
        <div className="footer" style={{
            ...
            <div className="left">
                ...
                <br />
                <p>background of stirling ridge walk by <a href="https://www.instagram.com/photo_ventures_with_yosh?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">Yoshi Muroi</a></p>
            </div>
            <div className="right">
